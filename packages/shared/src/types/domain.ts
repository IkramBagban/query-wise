...
export interface DashboardOwnerDto { contractVersion: ContractVersion; id: ResourceId; name: string; access: "owner"; mode: WidgetMode; defaultDateRange: DashboardDateRange | null; refreshIntervalSeconds: number | null; connectionDeleted: boolean; widgets: DashboardOwnerWidgetDto[]; createdAt: IsoDateTime; updatedAt: IsoDateTime }
