...
const STATIC_INSTRUCTIONS = [
  ...
  "- Cover blocks in ascending block order — the order the user sees them.",
  "- When the question is ambiguous (e.g. 'top selling' — units or revenue?), state the interpretation you chose in the block's lead-in.",
