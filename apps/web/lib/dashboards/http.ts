...
import type { ApiErrorCode } from "@query-wise/shared/types";
...
const STATUS_BY_CODE: Record<ApiErrorCode, number> = {
  ...
  PLAN_LIMIT_CONNECTIONS: 402,
  PLAN_LIMIT_DASHBOARDS: 402,
  PLAN_LIMIT_SHARES: 402,
  PLAN_FEATURE_PASSWORD_SHARES: 402,
  PLAN_FEATURE_MODEL: 402,
